...
locals {
  ...
  hcaptcha_site_key     = data.infisical_secrets.authentik.secrets["HCAPTCHA_SITE_KEY"].value
  hcaptcha_secret_key   = data.infisical_secrets.authentik.secrets["HCAPTCHA_SECRET_KEY"].value
